...
namespace OilSpillageImprovedFunctor {
	template<class DataKind>
	class Base {
	public:
		__host__ __device__ Base() { }
		Base(OilSpillageConsts consts, DataKind data)
	...
	public:
		...
		WaterU(OilSpillageConsts consts, DataKind data)
	...
	public:
		...
		WaterUx(OilSpillageConsts consts, DataKind data)
	...
	public:
		...
		WaterUy(OilSpillageConsts consts, DataKind data)
			: WaterU<DataKind>(consts, data) { }
	...
	public:
		...
		ImpurityAndPress(OilSpillageConsts consts, DataKind data)
			: Base<DataKind>(consts, data) { }
	...
	public:
		...
		Impurity(OilSpillageConsts consts, DataKind data)
	...
	public:
		...
		Press(OilSpillageConsts consts, DataKind data)
			: ImpurityAndPress<DataKind>(consts, data) { }
	...
	public:
		...
		WaterUxS(OilSpillageConsts consts, DataKind data)
			: Base<DataKind>(consts, data) { }
	...
	public:
		...
		WaterUyS(OilSpillageConsts consts, DataKind data)
			: Base<DataKind>(consts, data) { }
	...
	public:
		...
		WaterUx_Complete(OilSpillageConsts consts, DataKind data)
			: Base<DataKind>(consts, data) { }
	...
	public:
		...
		WaterUy_Complete(OilSpillageConsts consts, DataKind data)
			: Base<DataKind>(consts, data) { }
	...
	public:
		...
		OilUx(OilSpillageConsts consts, DataKind data)
			: Base<DataKind>(consts, data) { }
	...
	public:
		...
		OilUy(OilSpillageConsts consts, DataKind data)
			: Base<DataKind>(consts, data) { }
	...
	public:
		...
		PressS(OilSpillageConsts consts, DataKind data)
			: Base<DataKind>(consts, data) { }
	...
	public:
		...
		ImpurityS(OilSpillageConsts consts, DataKind data)
			: Base<DataKind>(consts, data) { }
	...
	public:
		...
		W(OilSpillageConsts consts, DataKind data)
			: Base<DataKind>(consts, data) { }
	...
	public:
		...
		ImpurityIstok(OilSpillageConsts consts, DataKind data)
			: Base<DataKind>(consts, data) { }
	...
	public:
		...
		IslandResolver(OilSpillageConsts consts, DataKind data)
			: Base<DataKind>(consts, data) { }
	...
	GpuDevice& Base<OilSpillageDataD>::gpu() const {
		return _data.gpu();
	}
