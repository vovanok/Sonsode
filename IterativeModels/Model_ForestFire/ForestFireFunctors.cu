...
namespace ForestFire {
	namespace Functors {
		...
		public:
			...
			Base(ForestFireConsts consts, DataKind data)
		...
		public:
			...
			T4(ForestFireConsts consts, DataKind data)
		...
		public:
			...
			Gorenie(ForestFireConsts consts, DataKind data)
				: Base<DataKind>(consts, data) { }
		...
		public:
			...
			Temperature(ForestFireConsts consts, DataKind data)
				: Base<DataKind>(consts, data) { }
		...
		GpuDevice& Base<ForestFireDataD>::gpu() const {
			return _data.gpu();
		}
	}
}