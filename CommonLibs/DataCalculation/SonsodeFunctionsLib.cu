...
namespace Sonsode {
	namespace FunctionsLib {
		//template<class FunctorType> void ExplicitGaussSeidel_1D_CPU(FunctorType fn);
		//template<class FunctorType> void ExplicitGaussSeidel_1D_GPU(FunctorType fn);
		...
		//template<class FunctorType> void ImplicitSweep_1D_CPU(HostData1D<T> sweepFactors, FunctorType fn);
		//template<class FunctorType> void ImplicitSweep_1D_GPU(DeviceData1D<T> sweepFactors, FunctorType fn);
...
namespace Sonsode {
	namespace FunctionsLib {
		...
		//template<class FunctorType> void ImplicitSweep_1D_CPU(FunctorType fn) {
		//}
		//
		//template<class FunctorType> void ImplicitSweep_1D_GPU(FunctorType fn) {
		//}
